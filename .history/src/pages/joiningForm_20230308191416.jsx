        ...
        <div className="w-2/3 mx-auto my-10 bg-white p-5 rounded-md shadow-sm">
          ...
          <div className="m-7">
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                <label htmlFor="semester" className="block mb-2 text-sm text-gray-600 dark:text-gray-400">
                  Semester
                </label>
                <input
                  type="number"
              ...
              <div className="mb-6">
                <label htmlFor="portfolio" className="block mb-2 text-sm text-gray-600 dark:text-gray-400">
                  Portfolio Link
                </label>
                <input
                  type="url"
              ...
              <div className="mb-6">
                <label htmlFor="programming-language" className="block mb-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="mb-6">
                <label htmlFor="technical-strength" className="block mb-2 text-sm text-gray-600 dark:text-gray-400">
                  Technical Strength
                </label>
                <textarea
                  name="technical-strength"
                  id="technical-strength"
                  value={technicalStrength}portfolio 
              ...
              <div className="mb-6">
                <label htmlFor="areas-of-interest" className="block mb-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="mb-6">
                <label htmlFor="additional-information" className="block mb-2 text-sm text-gray-600 dark:text-gray-400">
