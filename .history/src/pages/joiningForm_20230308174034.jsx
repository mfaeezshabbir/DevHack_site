...
function JoinForm() {
  ...
  return (
    <div className="flex items-center min-h-screen bg-gray-50 dark:bg-[#720d0d]">
        ...
        <div className="max-w-md mx-auto my-10 bg-white p-5 rounded-md shadow-sm">
          ...
          <div className="m-7">
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                <label htmlFor="portfolioLink" className="block mb-2 text-sm text-gray-600 dark:text-gray-400">
                portfolioLink
                </label>
                <input
                  type="text"
                  ...
                  placeholder="Example portfolioLink"
                  required
                  className="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 "
                />
              </div>
