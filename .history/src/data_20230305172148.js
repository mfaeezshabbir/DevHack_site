...
export const footerData = {
  ...
  footNote: `
    Made by <a class="text-blue-600 hover:underline dark:text-gray-200" href="https://github.com/mfaeezshabbir/ target="_bla"> M Faeez Shabbir</a> · All rights reserved.
  `,
};
